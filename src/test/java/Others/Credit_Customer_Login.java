...
######  Scenario Logs In, for credit Customers   ##### */

public class Credit_Customer_Login {
	...
	Logger logger = Logger.getLogger("Credit_Customer_Login");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void CreditCustomerLogin(String browsername) throws Exception {
		test = rep.startTest("Credit Customer Login");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Credit_Customer_Log_In/Log-In-Credentials.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Credit_Customer_Log_In/Log-In.jpg");

			// Catches throwable errors

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Error/Credit_Customer_Log_In/Log-In.jpg");
