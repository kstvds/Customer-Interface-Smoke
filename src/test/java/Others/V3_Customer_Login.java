...
/* #######  Test for Login V3 Customer #########
######  Scenario Logs In, for V3 Customers   ##### */

public class V3_Customer_Login {
	...
	Logger logger = Logger.getLogger("V3_Customer_Login");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void V3CustomerLogin(String browsername) throws Exception {
		test = rep.startTest("V3 Customer Login");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/V3_Customer_Log_In/Log-In-Credentials.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/V3_Customer_Log_In/Log-In.jpg");

			// Catches throwable errors

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Error/V3_Customer_Log_In/Log-In.jpg");
