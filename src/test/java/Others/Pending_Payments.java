...
/* #######  Test for pending payments  #########
######  User Logs In, Books accommodation with pending payment,then search for the pending payment booking ##### */
...
public class Pending_Payments {
	...
	Logger logger = Logger.getLogger("Pending_Payments");
	...
	public void PendingPayments(String browsername) throws Exception {
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Log-In.jpg";
		...
		try {
			 ...
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Confirm-Booking.jpg");
			...
			/*
			 * String ExpectedStatus = "Confirmed"; String ExpectedNoOfAdults =
			 * "2 Adults"; String ActualNoOfAdults =
			 * driverqa.findElement(Booking.noOfAdultsPrepay).getText(); String
			 * ActualStatus =
			 * driverqa.findElement(Booking.BookingStatusPrepay).getText();
			 * 
			 * JavascriptExecutor js = (JavascriptExecutor) driverqa;
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Booking-Done.jpg");
			/*
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		test.log(LogStatus.INFO, "Verifing Pending payment");
		logger.info("Verifing Pending payment");
		try {
			wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.PendingPayment));
			driverqa.findElement(Booking.PendingPayment).click();
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Pending-Payments-List.jpg");
			wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.ViewBooking));
			...
			JavascriptExecutor js = (JavascriptExecutor) driverqa;
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Booking-Details1.jpg");
			WebElement Element = driverqa.findElement(Booking.Invoice);
			...
			js.executeScript("arguments[0].scrollIntoView();", Element);
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Pending_Payments/Booking-Details2.jpg");
			Assert.assertTrue(ActualStatus.equalsIgnoreCase(ExpectedStatus));
			Assert.assertTrue(ActualNoOfAdults.equalsIgnoreCase(ExpectedNoOfAdults));
			test.log(LogStatus.PASS, "Verifing Pending payment");
			logger.info("Verifed Pending payment");
		} catch (Throwable e) {
			test.log(LogStatus.FAIL, "Pending payment");
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Pending-Payments.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Pending_Payments/Pending-Payments.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
