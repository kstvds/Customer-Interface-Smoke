...
/* #######  Test for new prepay customer registration  #########
######  User creates a new prepay customer registration and then activates the customer ##### */

public class Register_Prepay_Customer {
	...
	Logger logger = Logger.getLogger("Register_Prepay_Customer");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void RegisterPrepayCustomer(String browsername) throws Exception {
		test = rep.startTest("Register Prepay Customer");
		...
		try {
			...
			driverqa.get(URL);
			logger.info("Test Case Started");
			logger.info("Starting Register Prepay Customer");
			test.log(LogStatus.INFO, "Starting Register Prepay Customer");
			...
			dropdown2.selectByVisibleText("Prepay");
			...
			Select dropdown3 = new Select(driverqa.findElement(Ci_Register.Preffered_Currency_Prepay));
			...
			driverqa.findElement(Ci_Register.Login_Id).sendKeys(excel.getData(0, 60, 5));
			Thread.sleep(1000);
			driverqa.findElement(Ci_Register.Password).sendKeys(excel.getData(0, 60, 6));
			driverqa.findElement(Ci_Register.Confirm_Password).sendKeys(excel.getData(0, 60, 6));
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Filled-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Terms-and-conditions-page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Customer-Created.jpg");
			...
			test.log(LogStatus.PASS, "Register Prepay Customer");
			logger.info("Registered Prepay Customer");
			driverqa.close();
		}
		...
		// Catches throwable errors
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Customer-Creation.jpg");
			test.log(LogStatus.FAIL, "Customer Creation");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Customer-Creation.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Log-In-MyAdmin.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Log-In-MyAdmin.jpg");
			test.log(LogStatus.FAIL, "Login MyAdmin");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Log-In-MyAdmin.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Customer-FiltersPage.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Activating customer.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Prepay_Customer/Customer-Activated.jpg");
			logger.info("New customer activated successfully");
			test.log(LogStatus.PASS, "New customer activated successfully");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Customer-Activation.jpg");
			test.log(LogStatus.FAIL, "Customer Activation");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Prepay_Customer/Customer-Activation.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
