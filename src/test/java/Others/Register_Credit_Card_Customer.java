...
/* #######  Test for new credit card customer registration  #########
######  User creates a new credit card customer registration and then activates the customer ##### */

public class Register_Credit_Card_Customer {
	...
	Logger logger = Logger.getLogger("Register_Credit_Card_Customer");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void RegisterCreditCardCustomer(String browsername) throws Exception {
		test = rep.startTest("Register Credit Card Customer");
		...
		try {
			...
			driverqa.findElement(Ci_Register.Company_name).sendKeys("Kaustav Company");
			driverqa.findElement(Ci_Register.Company_Address).sendKeys("Kaustav Company");
			...
			dropdown1.selectByVisibleText("Nauvoo - IL");
			Select dropdown2 = new Select(driverqa.findElement(Ci_Register.Preffered_Payment_Method));
			dropdown2.selectByVisibleText("Credit Card");
			// wait.until(ExpectedConditions.visibilityOfElementLocated(Ci_Register.Preffered_Currency));
			// wait.until(ExpectedConditions.(Ci_Register.Preffered_Currency));
			Select dropdown3 = new Select(driverqa.findElement(Ci_Register.Preffered_Currency_Credit_Card));
			...
			driverqa.findElement(Ci_Register.Login_Id).sendKeys(excel.getData(0, 59, 5));
			Thread.sleep(1000);
			driverqa.findElement(Ci_Register.Password).sendKeys(excel.getData(0, 59, 6));
			driverqa.findElement(Ci_Register.Confirm_Password).sendKeys(excel.getData(0, 59, 6));
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Filled-Details.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Terms-and-conditions-page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Customer-Created.jpg");
		...
		// Catches throwable errors
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Customer-Creation.jpg");
			test.log(LogStatus.FAIL, "Customer Creation");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Customer-Creation.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Log-In-MyAdmin.jpg");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Log-In-MyAdmin.jpg");
			test.log(LogStatus.FAIL, "Login MyAdmin");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Log-In-MyAdmin.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			logger.info("Activating new customer card");
			logger.info("Navigating to customer card filter page");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Customer-FiltersPage.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Activating customer.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Register_Credit_Card_Customer/Customer-Activated.jpg");
			logger.info("New customer activated successfully");
			test.log(LogStatus.PASS, "New customer activated successfully");

		} catch (Throwable e) {
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Customer-Activation.jpg");
			test.log(LogStatus.FAIL, "Customer Activation");
			errorpath = Config.SnapShotPath() + "/Others/Error/Register_Credit_Card_Customer/Customer-Activation.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
