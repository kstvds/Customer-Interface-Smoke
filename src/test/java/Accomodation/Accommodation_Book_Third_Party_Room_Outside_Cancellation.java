...
/* #######  Test for Accommodation booking for Third Party room  #########
######  User Logs In, Searches for Third Party room outside cancellation then books the room ##### */

public class Accommodation_Book_Third_Party_Room_Outside_Cancellation {
    ...
    Logger logger = Logger.getLogger("Accommodation_Book_Third_Party_Room_Outside_Cancellation");
	
    /* ####### Passing browser as parameters in test ######### **/
    
	 @Test
	 @Parameters({ "browsername" })
	  public void AccommodationBookThirdPartyRoomOutsideCancellation(String browsername) throws Exception {
		  test = rep.startTest("Accommodation Book Third Party Room Outside Cancellation");
		...
		if (browsername.equalsIgnoreCase("CH")) {
	           ...
	           try{
				...
				Thread.sleep(2000);
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Log-In.jpg");

		} catch (Throwable e) {
			
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath=Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Log-In.jpg";
			...
			Assert.assertTrue(false, e.getMessage());
	           ...
	           try {
				logger.info("Applying search Filters");
				   ...
				   driverqa.findElement(Search.nextmnth).click();
					...
					wait.until(ExpectedConditions.visibilityOfElementLocated(Search.CalenderIN));
						...
						Thread.sleep(2000);
						obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Filters.jpg");
					    String expectedresult=excel.getData(0, 11, 1);
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Search-Result.jpg");
				errorpath=Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Search-Result.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
	           ...
	           try {
				test.log(LogStatus.INFO, "Starting Hotel Book");
				   ...
				   wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.OnePaxFirstName));
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Booking-Details1.jpg");
					...
					Thread.sleep(2000);
					obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Booking-Details2.jpg");
				...
				obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Booking.jpg");
				errorpath=Config.SnapShotPath() + "/Accommodation/Error/Accommodation_Book_Third_Party_Room_Outside_Cancellation/Booking.jpg";
				logger.info(e.getMessage());
				test.log(LogStatus.FAIL, e.getMessage());
				rep.endTest(test);
				rep.flush();
