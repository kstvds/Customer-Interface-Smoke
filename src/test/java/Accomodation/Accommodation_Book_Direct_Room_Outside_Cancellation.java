...
/* #######  Test for Accommodation booking for Direct room  #########
######  User Logs In, Searches for Direct room outside cancellation then books the room ##### */

public class Accommodation_Book_Direct_Room_Outside_Cancellation {
	...
	Logger logger = Logger.getLogger("Accommodation_Book_Direct_Room_Outside_Cancellation");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void AccommodationBookDirectRoomOutsideCancellation(String browsername) throws Exception {
		test = rep.startTest("Accommodation Book Direct Room Outside Cancellation");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Direct_Room_Outside_Cancellation/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Direct_Room_Outside_Cancellation/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Direct_Room_Outside_Cancellation/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		/*	if (driverqa.findElements(Booking.TwoPaxFirstName).size() != 0) {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Direct_Room_Outside_Cancellation/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Direct_Room_Outside_Cancellation/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Direct_Room_Outside_Cancellation/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
