...
######  User Logs In, Books accommodation then searches for the respective booking ##### */

public class Find_Booking {
	...
	Logger logger = Logger.getLogger("Find_Booking");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void FindBooking(String browsername) throws Exception {
		test = rep.startTest("Find Booking");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Log-In.jpg";
		...
		try {
			 ...
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Booking-Details1.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/Search-Booking-Page.jpg");
			...
			JavascriptExecutor js = (JavascriptExecutor) driverqa;
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Find_Booking/View-Booking.jpg");
			// WebElement Element = driverqa.findElement(Booking.Invoice);
			// This will scroll the page till the element is found
			/*
			 * Assert.assertTrue(ActualStatus.equalsIgnoreCase(ExpectedStatus));
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Search-Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Find_Booking/Search-Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
