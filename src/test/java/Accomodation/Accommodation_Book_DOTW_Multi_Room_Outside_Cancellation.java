...
/* #######  Test for Accommodation booking for DOTW multiple room outside cancellation  #########
######  User Logs In, Searches for DOTW multiple room outside cancellation, books the rooms for that hotel ##### */

public class Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation {
	...
	Logger logger = Logger.getLogger("Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void AccommodationBookDOTWMultiRoomOutsideCancellation(String browsername) throws Exception {
		test = rep.startTest("Accommodation Book DOTW Multi Room Outside Cancellation");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Two-rooms.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_DOTW_Multi_Room_Outside_Cancellation/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
