...
public class Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation {
	...
	Logger logger = Logger.getLogger("Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void AccommodationBookThirdPartyMultiRoomOutsideCancellation(String browsername) throws Exception {
		test = rep.startTest("Accommodation Book Third party Multi Room Outside Cancellation");
		...
		try {
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Log-In.jpg");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Two-rooms.jpg");
			String expectedresult = excel.getData(0, 15, 1);
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Search-Result.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Booking-Details1.jpg");
			/*
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Third_Party_Multi_Room_Outside_Cancellation/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
