...
/* #######  Test for Accommodation booking for adult with children  #########
######  User Logs In, Books accommodation for 2 adults and 1 child ##### */

public class Accomodation_Book_Adult_With_Children {
	...
	Logger logger = Logger.getLogger("Accomodation_Book_Adult_With_Children");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void AccomodationBookAdultWithChildren(String browsername) throws Exception {
		test = rep.startTest("Accomodation Book Adult With Children");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Accommodation_Book_Adult_With_Children/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Error/Accommodation_Book_Adult_With_Children/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Accomodation/Error/Accommodation_Book_Adult_With_Children/Log-In.jpg";
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Accommodation_Book_Adult_With_Children/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Accommodation_Book_Adult_With_Children/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Adult_With_Children/Search-Result.jpg");
		...
		try {
			 ...
			 * getData(0, 21, 1)); Thread.sleep(2000);
			 * driverqa.findElement(Booking.TwoPaxLastName).sendKeys(excel.
			 * getData(0, 21, 2)); Select passengertitle2 = new
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Adult_With_Children/Passenger-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Accommodation_Book_Adult_With_Children/Confirm-Booking.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Accommodation_Book_Adult_With_Children/Payment-Details.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Adult_With_Children/Search-Booking-Page.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Adult_With_Children/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath()
					+ "/Accomodation/Accommodation_Book_Adult_With_Children/Booking-Details2.jpg");
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Accomodation/Error/Accommodation_Book_Adult_With_Children/Booking.jpg");
			errorpath = Config.SnapShotPath()
					+ "/Accomodation/Error/Accommodation_Book_Adult_With_Children/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
