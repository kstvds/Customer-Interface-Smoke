...
/* #######  Search for a booked transfer #########
######  Scenario Logs In, Books a specified transfer then searches for the booked transfer and verifies  ##### */

public class Find_Transfer_Booking {
	...
	Logger logger = Logger.getLogger("Find_Transfer_Booking");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void FindTransferBooking(String browsername) throws Exception {
		test = rep.startTest("Find Transfer Booking");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Log-In.jpg";
		...
		try {
			 ...
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Search-Result.jpg");
		...
		try {
			...
			obj.Takesnap(driverqa,
					Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Available_Transfer_List.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Booking-Details1.jpg");
			// This will scroll the page till the element is found
			js1.executeScript("window.scrollTo(0, document.body.scrollHeight)");
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Booking-Details2.jpg");
			wait.until(ExpectedConditions.visibilityOfElementLocated(Booking.BookingStatusPrepay));
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		logger.info("Searching Transfer Booking Details");
		test.log(LogStatus.INFO, "Searching Transfer Booking Details");
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Find_Transfer_Booking/Search-Booking-Page.jpg");
			...
			Assert.assertTrue(ActualTransferPickUp.equalsIgnoreCase(ExpectedTransferPickUp));
			Assert.assertTrue(ActualTransferDate.contains(ExpectedTransferDate));
			test.log(LogStatus.PASS, "Searching Transfer Booking Details");
			logger.info("Searched Transfer Booking Details");
		}

		catch (Throwable e) {
			test.log(LogStatus.FAIL, "Search Transfer Booking");
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Search-Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Transfer/Error/Find_Transfer_Booking/Search-Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
