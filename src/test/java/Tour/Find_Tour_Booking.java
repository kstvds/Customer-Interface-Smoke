...
/* #######  Search for a booked tour #########
######  Scenario Logs In, Books a specified Tour then searches for the booked tour and verifies  ##### */

public class Find_Tour_Booking {
	...
	Logger logger = Logger.getLogger("Find_Tour_Booking");

	/* ####### Passing browser as parameters in test ######### **/

	@Test
	@Parameters({ "browsername" })
	public void FindTourBooking(String browsername) throws Exception {
		test = rep.startTest("Find Tour Booking");
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Log-In.jpg");

		} catch (Throwable e) {

			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Error/Find_Booking/Log-In.jpg");
			test.log(LogStatus.FAIL, "Login");
			errorpath = Config.SnapShotPath() + "/Tour/Error/Find_Booking/Log-In.jpg";
		...
		try {
			 ...
			 */
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Filters.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Search-Result.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Error/Find_Booking/Search-Result.jpg");
			errorpath = Config.SnapShotPath() + "/Tour/Error/Find_Booking/Search-Result.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		try {
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Avaailable_Tour_List.jpg");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Passenger-Details.jpg");
			 ...
			 * ProccedToBook)); Thread.sleep(2000); obj.Takesnap(driverqa,
			 * Config.SnapShotPath() +
			 * "/Tour/Book_Tour/Confirm-Tour-Booking.jpg");
			 * driverqa.findElement(Booking.ProccedToBook).click(); logger.info(
			 * "Entering Payment details"); test.log(LogStatus.INFO,
			 * "Entering Payment details");
			 * wait.until(ExpectedConditions.visibilityOfElementLocated(
			 * PaymentPage.FirstName)); WebElement FirstName =
			 * driverqa.findElement(PaymentPage.FirstName); FirstName.clear();
			 * FirstName.sendKeys(excel.getData(0, 22, 1)); WebElement LastName
			 * = driverqa.findElement(PaymentPage.LastName); LastName.clear();
			 * LastName.sendKeys(excel.getData(0, 22, 2)); WebElement Address =
			 * driverqa.findElement(PaymentPage.Address); Address.clear();
			 * Address.sendKeys("Kolkata1234"); WebElement CardNo =
			 * driverqa.findElement(PaymentPage.CardNumber); CardNo.clear();
			 * CardNo.sendKeys(excel.getData(0, 21, 5)); WebElement CVVNo =
			 * driverqa.findElement(PaymentPage.CVVNumber); CVVNo.clear();
			 ...
			 * Config.SnapShotPath() + "/Tour/Book_Tour/Payment-Details.jpg");
			...
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Error/Find_Booking/Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Tour/Error/Find_Booking/Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
		...
		logger.info("Searching  Tour Booking Details");
		test.log(LogStatus.INFO, "Searching Tour Booking Details");
		try {
			...
			dropdown_manager.selectByValue("4");
			...
			Thread.sleep(2000);
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Find_Booking/Search-Booking-Page.jpg");
			...
			Assert.assertTrue(ActualTourPickUp.equalsIgnoreCase(ExpectedTourPickUp));
			Assert.assertTrue(ActualTourDate.contains(ExpectedTourDate));
			test.log(LogStatus.PASS, "Searching Tour Booking Details");
			logger.info("Searched Tour Booking Details");
		}

		catch (Throwable e) {
			test.log(LogStatus.FAIL, "Search Tour Booking");
			obj.Takesnap(driverqa, Config.SnapShotPath() + "/Tour/Error/Find_Booking/Search-Booking.jpg");
			errorpath = Config.SnapShotPath() + "/Tour/Error/Find_Booking/Search-Booking.jpg";
			logger.info(e.getMessage());
			test.log(LogStatus.FAIL, e.getMessage());
			rep.endTest(test);
			rep.flush();
